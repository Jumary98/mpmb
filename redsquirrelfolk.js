...
RaceList["Red Squirrelfolk"] = { //Object name; Note the use of only lower case! Also note the absence of the word "var" and the use of brackets []
	...
	sortname : "Squirrelfolk, Red", //optional; this is the name used to fill the drop-down boxes. If you don't include this, the 'name' will used instead
	...
	plural : "Red Squirrelfolk", //required; the name to use for the race when the plural form is used
...
/* SYNTAX CHANGE v12.998 >> old syntax for 'tools' and 'languages' are no longer supported!! */
	...
	skills : ["Perception", "Persuasion"], //optional; Skill proficiencies the race has. This line can be deleted if you don't have anything to put here. If the race doesn't give fixed proficiencies, but instead gives a choice, delete this line and use the line below, "skillstxt"
	...
	improvements : "Red Squirrelfolk: +2 Dexterity, +1 Charisma;", //required; the text that is displayed when listing all the ability score improvements
